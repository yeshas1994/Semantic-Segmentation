...
def get_resnet_pretrained(model_name, pretrained=True, progress=True):
    ...
    resnet_pretrained = {
        ...
        'resnet34' : resnet34(pretrained, progress),
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.avgpool = nn.AdaptiveAvgPool2d((1, 1)) # unused
        self.fc = nn.Linear(512 * block.expansion, num_classes) # unused
